...
const TransactionsHeader = ({ transactions }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-baseline sm:items-center gap-4 sm:gap-0">
      <Heading title={"Transactions"} />
      <Button
        type="outline"
        onClick={() => setExportOpen(true)}
        className={
          "border rounded cursor-pointer bg-transparent hover:bg-[#25252c] gap-2"
        }
      >
        ...
        >
          ...
          >
            ...
            <div className="flex justify-baseline items-center gap-2">
              ...
              <Label htmlFor="all">
                All Transactions ({exportData.length})
              </Label>
            </div>
          </RadioGroup>
