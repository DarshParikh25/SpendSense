CREATE TYPE "public"."account_type" AS ENUM('bank', 'cash', 'credit_card', 'crypto', 'investments', 'savings');--> statement-breakpoint
CREATE TYPE "public"."bank_category" AS ENUM('current_account', 'savings_account', 'fixed_deposit', 'recurring_deposit');--> statement-breakpoint
CREATE TYPE "public"."cash_category" AS ENUM('petty_cash', 'wallet', 'safe_locker');--> statement-breakpoint
CREATE TYPE "public"."credit_card_category" AS ENUM('visa', 'amex', 'mastercard', 'rupay');--> statement-breakpoint
CREATE TYPE "public"."crypto_category" AS ENUM('bitcoin', 'ethereum', 'altcoins', 'stablecoins', 'multi_coins');--> statement-breakpoint
CREATE TYPE "public"."investment_category" AS ENUM('stocks', 'ppf', 'mutual_funds', 'etf', 'bonds');--> statement-breakpoint
CREATE TYPE "public"."savings_category" AS ENUM('general_savings');--> statement-breakpoint
