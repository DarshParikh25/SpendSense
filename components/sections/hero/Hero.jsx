...
const Hero = () => {
  return (
    <div className="px-6 sm:px-12 md:px-20 py-8 md:py-16 flex flex-col justify-center items-center gap-20">
      <div className="text-center flex flex-col justify-center items-center font-bold w-full gap-4">
        <h1 className="text-[36px] sm:text-[42px] md:text-[64px] lg:text-[90px] leading-10 md:leading-18 lg:leading-24 lg:w-5xl">
